        ...
        <div className='main-content mt-5'>
            ...
            <Table responsive className="folders-table-1">
                ...
                <tr className='table-hover'>
                    ...
                    <td className='center'><Image className='ml-auto' src='Images/homepage/fillstar.svg' /></td>
                    <td >
                ...
                <tr className='table-hover'>
                    ...
                    <td className='center'><Image className='ml-auto' src='Images/homepage/unfillstar.svg' /></td>
                    <td >
